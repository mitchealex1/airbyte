...
import pytest
from source_new_relic.source import NewRelicStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(NewRelicStream, "path", "v0/example_endpoint")
    mocker.patch.object(NewRelicStream, "primary_key", "test_primary_key")
    mocker.patch.object(NewRelicStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = NewRelicStream()
